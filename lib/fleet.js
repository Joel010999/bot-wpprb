...
export async function scrapeChatHistory(page, onLog = null) {
    ...
    const UI_TEXT_BLACK_LIST = [
        ...
        "You followed this account", "Esta cuenta es privada", "Privacidad", "Instagram",
        "Sincronizar", "Mensaje"
    ];
    ...
    for (let i = 0; i < count; i++) {
        ...
        // Filtro de longitud (evitar letras sueltas y ruidos cortos como 'd', '1w')
        if (!cleanTxt || cleanTxt.length <= 5) continue;

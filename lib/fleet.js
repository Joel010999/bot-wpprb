...
// ── Enviar y Verificar DM (MODIFICADO: SCRIPT FIJO RENDERBYTE + FIX INPUT) ──
export async function sendAndVerifyDM(page, targetHandle, messageOrData, onLog = () => { }) {
    ...
    // ARSENAL DE SELECTORES PARA LA CAJA DE TEXTO (FIX INSTAGRAM WEB)
    const INPUT_SELECTORS = [
        'div[contenteditable="true"][role="textbox"]',
        'textarea[placeholder*="mensaje" i]',
        'textarea[placeholder*="message" i]',
        'div[aria-placeholder*="mensaje" i]',
        'div[aria-placeholder*="message" i]',
        'div.xzsf02u[contenteditable="true"]', // Clases ofuscadas comunes
        'div[data-lexical-editor="true"]'      // Nuevo editor de Meta
    ].join(', ');
    ...
    try {
        ...
        // HACK: Click ciego en el centro de la zona de chat para activar focus o romper overlays
        ...
        try {
            ...
            onLog(`[${ts()}] ⚠️ Input sigue sin aparecer. Recargando chat...`);
    ...
    for (let i = 0; i < fragments.length; i++) {
        ...
        // Limpiar el input por si quedó texto trabado

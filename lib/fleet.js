...
// ── Enviar y Verificar DM (MODIFICADO: FIX VIEWPORT NULL Y SCRIPT RENDERBYTE) ──
export async function sendAndVerifyDM(page, targetHandle, messageOrData, onLog = () => { }) {
    ...
    try {
        ...
        // HACK REPARADO: Usamos evaluate porque viewportSize() es null en pantalla completa
        try {
            await page.keyboard.press("Escape"); // Escape cierra casi cualquier modal de IG

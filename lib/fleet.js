...
export async function sendAndVerifyDM(page, targetHandle, messageOrData, onLog = () => { }) {
    ...
    if (hasPreviousMessages) {
        onLog(`[${ts()}] 🛑 DOBLE CAPA ANTI-SPAM: Ya existe historial con este lead. Abortando envío de script y marcando como exitoso.`);
    ...
    for (let i = 0; i < fragments.length; i++) {
        ...
        // Pausa de 2 segundos exacta requerida (Estilo Lorenzo)
        await page.waitForTimeout(2000);
